...
namespace CodeMonkey.Toolkit.ShopSimulatorDemo {
    ...
    public class ShelveInteractableScipt : MonoBehaviour, IInteractable {
        ...
        public Dictionary<IInteractable.InteractAction, string> GetInteractTextDictionary() {
            return new Dictionary<IInteractable.InteractAction, string>{
                { IInteractable.InteractAction.Stock, "Skladovat" },
                { IInteractable.InteractAction.Unstock, "Odstranit" },
                { IInteractable.InteractAction.ChangePrice, "Změnit cenu" },
            };
        }
